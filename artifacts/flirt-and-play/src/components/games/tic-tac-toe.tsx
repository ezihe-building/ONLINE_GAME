      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 p-4 sm:p-6 bg-card rounded-2xl border border-border shadow-[0_0_50px_-15px_rgba(236,72,153,0.15)]">
        {board.map((cell, i) => (
          <div
            ...
            className={`w-20 h-20 sm:w-28 sm:h-28 flex items-center justify-center text-4xl sm:text-6xl font-black rounded-xl transition-all duration-300
              ...
              ${!isMyTurn || isSpectator || cell !== null ? 'cursor-default' : 'cursor-pointer'}
            `}
          >
